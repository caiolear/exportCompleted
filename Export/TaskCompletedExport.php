...
namespace Kanboard\Plugin\ExportCompleted\Export;
 ...
 */
class TaskCompletedExport extends Base
{
    /**
    ...
    protected function getTasks($project_id, $from, $to)
    {
        ...
        return $this->db->table(TaskModel::TABLE)
            ...
            ->gte(TaskModel::TABLE . '.date_completed', $from)
            ->lte(TaskModel::TABLE . '.date_completed', $to)
