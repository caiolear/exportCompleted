...
namespace Kanboard\Plugin\ExportCompleted\Controller;
 ...
 * Export Controller
 *
 * @package  Kanboard\Plugin\ExportCompleted\Controller
 * @author   Caio Maia
 */
class ExportController extends BaseController
{
	...
	/**
     * Exportar tarefas finalizadas
     *
     * @access public
     */
    public function completed()
    {
        $this->common('TaskCompletedExport', 'export', ('Tarefas Finalizadas'), 'completed', t('Tasks Export'));
    }
