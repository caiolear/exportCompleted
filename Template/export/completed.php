...
<form class="js-modal-ignore-form" method="post" action="<?= $this->url->href('ExportController', 'completed', array('project_id' => $project['id'])) ?>" autocomplete="off">
    <?= $this->form->csrf() ?>
    ...
    <div class="form-actions">
        ...
        <?= t('or') ?>
        <?= $this->url->link(t('cancel'), 'ExportController', 'completed', array('project_id' => $project['id']), false, 'js-modal-close') ?>
    </div>
</form>
